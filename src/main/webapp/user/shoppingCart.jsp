...
<%
	ShoppingCart shopping = (ShoppingCart) session.getAttribute("shoppingCart");
	Map<Integer, Orderline> map = shopping.getMap();
	//out.print(map);//Debug:传输参数
%>
...
<table cellpadding=3 cellspacing=1 align=center class=tableborder1>
	...
	<c:forEach var="line" items='<%=map%>'>
		<tr>
			<form method="post" action="updateProduct" name="f1">
				<input type="hidden" name="productid" value='${line.key }'> 
				<td class=tablebody2 valign=middle align=center width="">${line.key }</td>
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a
					href="user/productDetail.jsp?productid=${line.key }">${line.value.book.name }</a></td>
				...
				<td class=tablebody1 valign=middle align=center width=""><input
					type="text" name="num" value="${line.value.num }" size="4"
				...
				<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;￥
					${line.value.book.price * line.value.num}</td>
				<td class=tablebody1 valign=middle align=center width=""><input
					type="button" value="取消"
					onclick="javascript:window.location='removeProduct?productid=${line.key}';">
	...
	<tr>
		...
		<td class=tablebody1 valign=middle align=left width="">&nbsp;&nbsp;<font
			color="#ff0000"><b>￥<%=shopping.getCost()%></b></font></td>
	...
	<tr>
		<td class=tablebody2 valign=middle align=center colspan="6"><input
			...
			onclick="javascript:window.location='shopcartClear';"></td>
	</tr>
</table>
<br>
<!--文件尾开始-->
