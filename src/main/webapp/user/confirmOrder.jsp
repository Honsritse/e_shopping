	...
	<table cellpadding=3 cellspacing=1 align=center class=tableborder1
		...
		<tr>
			<td valign=middle align=center height=25 background="images/bg2.gif"
				...
				type="button" value="修改"
				onclick="javascript:window.location='user/shoppingCart.jsp';"></td>
		</tr>


		<c:forEach var="line" items='${sessionScope.shoppingCart.map}'>
			<tr>
				<td class=tablebody2 valign=middle align=center width="">${line.key }</td>
				<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a
					href="user/productDetail?id=1" target="_blank">${line.value.book.name }</a></td>
				<td class=tablebody2 valign=middle align=center width="">价格：${line.value.book.price} </td>
				<td class=tablebody1 valign=middle align=center width="">数量：${line.value.num }</td>
				<td class=tablebody2 valign=middle align=left width="">小计：￥${line.value.num * line.value.book.price}</td>
			</tr>
		</c:forEach>
			...
			<tr>
				...
				<td class=tablebody1 valign=middle align=left width="">合计：<font
					color="#ff0000"><b>￥${sessionScope.shoppingCart.cost }</b></font></td>
			</tr>
	</table>
	<p align="center">
		请认真检查以上订单信息，确认无误后，点击 → <a
			href="orderSave"
			style="cursor: pointer;"><img src="images/submit.gif"></a>
	</p>
</form>
